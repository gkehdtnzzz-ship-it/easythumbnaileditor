...
1. Replace all `https://example.com/` values in `index.html`, `robots.txt`, and `sitemap.xml` with the real domain.
...
7. Replace `https://example.com/` in `index.html`, `robots.txt`, and `sitemap.xml` with the final Pages URL or your custom domain.
